...
%\noappendixalgorithms          % Don't have appendix figures
...
\bibliographystyle{plain}
 ...
 \include{intro}                 % Chapter 1. ``Introduction and Motivation''
+\include{krylov}              % Chapter 2, ``Krylov for upscattering''
+\include{eigenvalue}    % Chapter 3, ``Eigenvalue acceleration plan''
+\include{precond}          % Chapter 4, ``preconditioning''
+\include{conclusion}         % Chapter 5, ``The plan''
